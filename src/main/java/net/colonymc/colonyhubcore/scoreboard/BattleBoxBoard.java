...
public class BattleBoxBoard {
	...
	private static String getLeft(net.colonymc.colonyhubcore.fun.battlebox.Team t) {
		net.colonymc.colonyhubcore.fun.battlebox.Team toCount = Main.getInstance().getBox().getTeams().get(0).equals(t) ? Main.getInstance().getBox().getTeams().get(1) : Main.getInstance().getBox().getTeams().get(0);
		int c = 0;
	...
	private static String getOppPoints(net.colonymc.colonyhubcore.fun.battlebox.Team t) {
		net.colonymc.colonyhubcore.fun.battlebox.Team toCount = Main.getInstance().getBox().getTeams().get(0).equals(t) ? Main.getInstance().getBox().getTeams().get(1) : Main.getInstance().getBox().getTeams().get(0);
